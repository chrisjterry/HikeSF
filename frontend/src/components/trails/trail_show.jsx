...
class TrailShow extends React.Component {
  ...
  componentWillMount() {
    //   debugger
    this.props.fetchTrail(this.props.match.params.id).then(() => {
  ...
  render() {
    ...
    return (
      <div className="trail-show-container">
        <div className="trail-show-wrapper">
          <h1 className="trail-show-title">Trail title goes here-{trail.title}</h1>
          <div className="trail-show-link">
            <Link className="trail-show-link" to={`/trails/${trail.id}`}>
              ...
              <div className="trail-show-rating">
                Rating - ★★★★★
                </div>
